...
@Table({ schema: 'core', tableName: 'template_targets' })
export class TemplateTarget extends Model<
  InferAttributes<TemplateTarget>,
  InferCreationAttributes<TemplateTarget>
> {
  ...
  @EnumColumn('target_type', TargetingType)
  readonly targetType!: CreationOptional<TargetingType>;

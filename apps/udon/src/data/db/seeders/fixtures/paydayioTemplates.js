const ORGANIZATION = {
  name: 'PaydayIO',
  slug: 'paydayio',
  entityId: 'bec15fa4-6803-11eb-b454-d756c991927e',
};
...
![Text](/text.png)`,
  ...
  },
  {
    ...
    steps: [
      {
        name: 'SCIM / SSO',
        body: `Here's a video of how you integrate your SSO with PaydayIO
...
const TEMPLATES = [
  {
    name: 'Admin setup',
    description: 'Initial setup to start using PaydayIO for awesome things.',

      ...
      <g filter={`url(#filter0${ranKey})`}>
        <g clipPath={`url(#clip0${ranKey})`}>
          <rect
            ...
            fill="white"
          />
          <rect x="85" y="8" width="16" height="17" rx="2" fill="#E1ECFF" />
          <rect
            x="9"
            y="8.5"
            width="34"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_983_41457"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_dropShadow_983_41457"
            result="effect2_dropShadow_983_41457"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect2_dropShadow_983_41457"
            result="shape"
          />
        </filter>

/**
 * @generated SignedSource<<96b997703ea3b9b6c1c6c8e50a8b6b51>>
...
export type SetUISettingsInput = {
  additionalColors?: ReadonlyArray<AdditionalColorsInputType> | null;
  allGuidesStyle?: AllGuidesStyleInputType | null;
  appContainerIdentifier?: string | null;
  bannersStyle?: BannersStyleStyleInputType | null;
  borderColor?: string | null;
  cardBackgroundColor?: string | null;
  ctasStyle?: CtasStyleStyleInputType | null;
  cyoaBackgroundColor?: string | null;
  cyoaOptionBackgroundColor?: string | null;
  cyoaOptionBorderColor?: string | null;
  cyoaOptionShadow?: string | null;
  cyoaOptionShadowHover?: string | null;
  cyoaTextColor?: string | null;
  embedBackgroundHex?: string | null;
  embedCustomCss?: string | null;
  embedToggleBehavior?: EmbedToggleBehaviorType | null;
  floatingAnchorXOffset?: number | null;
  floatingAnchorYOffset?: number | null;
  fontColorHex?: string | null;
  helpCenter?: HelpCenterInput | null;
  helpCenterStyle?: HelpCenterStyleInput | null;
  inlineContextualStyle?: InlineContextualStyleInputType | null;
  inlineEmptyBehaviour?: InlineEmptyBehaviourType | null;
  isEmbedToggleColorInverted?: boolean | null;
  modalsStyle?: ModalsStyleStyleInputType | null;
  paragraphFontSize?: number | null;
  paragraphLineHeight?: number | null;
  primaryColorHex?: string | null;
  quickLinks: ReadonlyArray<QuickLinkInput | null>;
  responsiveVisibility?: ResponsiveVisibilityInputType | null;
  secondaryColorHex?: string | null;
  sidebarAvailability?: SidebarAvailabilityType | null;
  sidebarBackgroundColor?: string | null;
  sidebarBlocklistedUrls?: ReadonlyArray<string | null> | null;
  sidebarHeader?: GuideHeaderSettingsInputType | null;
  sidebarSide?: string | null;
  sidebarStyle?: string | null;
  sidebarVisibility?: SidebarVisibilityType | null;
  stepCompletionStyle?: string | null;
  stepSeparationStyle?: StepSeparationStyleInputType | null;
  tagBadgeIconBorderRadius?: number | null;
  tagBadgeIconPadding?: number | null;
  tagCustomIconUrl?: string | null;
  tagDotSize?: number | null;
  tagPrimaryColor?: string | null;
  tagPulseLevel?: VisualTagPulseLevelType | null;
  tagShadow?: string | null;
  tagTextColor?: string | null;
  tagVisibility?: TagVisibilityType | null;
  theme?: ThemeType | null;
  toggleColorHex?: string | null;
  toggleStyle?: string | null;
  toggleText?: string | null;
  toggleTextColor?: string | null;
  tooltipsStyle?: TooltipsStyleStyleInputType | null;
};
export type GuideHeaderSettingsInputType = {
  closeIcon: GuideHeaderCloseIconType;
  progressBar?: GuideHeaderProgressBarType | null;
  showModuleNameInStepView: boolean;
  type: GuideHeaderStyleType;
};
export type StepSeparationStyleInputType = {
  boxActiveStepShadow: ActiveStepShadowType;
  boxBorderRadius: number;
  boxCompleteBackgroundColor?: string | null;
  type: StepSeparationType;
};
export type InlineContextualStyleInputType = {
  borderColor?: string | null;
  borderRadius: number;
  padding: number;
  shadow: InlineContextualType;
};
export type AdditionalColorsInputType = {
  value: string;
};
export type AllGuidesStyleInputType = {
...
export type HelpCenterInput = {
  issueSubmission?: boolean | null;
  kbSearch?: boolean | null;
  liveChat?: boolean | null;
  source: HelpCenterSource;
  targeting?: any | null;
  url?: string | null;
};
export type HelpCenterStyleInput = {
  chatTitle?: string | null;
  supportTicketTitle?: string | null;
};
export type ModalsStyleStyleInputType = {
  backgroundOverlayColor?: string | null;
  backgroundOverlayOpacity?: number | null;
  borderRadius?: number | null;
  paddingX?: number | null;
  paddingY?: number | null;
  shadow?: AnnouncementShadowType | null;
};
export type TooltipsStyleStyleInputType = {
  borderRadius?: number | null;
  paddingX?: number | null;
  paddingY?: number | null;
  shadow?: AnnouncementShadowType | null;
};
export type CtasStyleStyleInputType = {
  borderRadius?: number | null;
...
export type BannersStyleStyleInputType = {
  borderRadius?: number | null;
  padding?: BannerPaddingType | null;
  shadow?: AnnouncementShadowType | null;
};
export type ResponsiveVisibilityInputType = {
  all?: ResponsiveVisibilityBehaviorType | null;
};
export type SetUISettingsMutation$variables = {
  input: SetUISettingsInput;
};
export type SetUISettingsMutation$data = {
  readonly setUISettings: {
...
export type SetUISettingsMutation = {
  response: SetUISettingsMutation$data;
  variables: SetUISettingsMutation$variables;
};
...
v11 = [
  {
    ...
    "concreteType": "SetUISettingsPayload",
    "kind": "LinkedField",
    "name": "setUISettings",
    "plural": false,
    "selections": [

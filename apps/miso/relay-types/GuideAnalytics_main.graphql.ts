/**
 * @generated SignedSource<<16469e506abe170cfeab9db43bde3b29>>
...
export type GuideAnalytics_main$data = {
  ...
  readonly theme: ThemeType;
  readonly type: GuideTypeEnumType;
  readonly " $fragmentType": "GuideAnalytics_main";
};
export type GuideAnalytics_main$key = {
  readonly " $data"?: GuideAnalytics_main$data;
  readonly " $fragmentSpreads": FragmentRefs<"GuideAnalytics_main">;
};
...
(node as any).hash = "38470a96bf4c8042311094a735cbafc6";

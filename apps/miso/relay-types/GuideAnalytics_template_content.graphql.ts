/**
 * @generated SignedSource<<0928ce957177107c65867e25546180d3>>
...
export type GuideAnalytics_template_content$data = {
  ...
  readonly " $fragmentType": "GuideAnalytics_template_content";
};
export type GuideAnalytics_template_content$key = {
  readonly " $data"?: GuideAnalytics_template_content$data;
  readonly " $fragmentSpreads": FragmentRefs<"GuideAnalytics_template_content">;
};
...
return {
  ...
  "kind": "Fragment",
  "metadata": null,
  "name": "GuideAnalytics_template_content",
  "selections": [
    (v0/*: any*/),
    {
      "alias": null,
...
(node as any).hash = "abb1cec15a5ae2242230f59650fb71be";

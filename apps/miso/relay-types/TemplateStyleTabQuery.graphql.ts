/**
 * @generated SignedSource<<b6d444f95c245c0dd2eb2041154eb833>>
...
export type TemplateStyleTabQuery = {
  response: TemplateStyleTabQuery$data;
  variables: TemplateStyleTabQuery$variables;
};

/**
 * @generated SignedSource<<5b31eaba4c341c78afb21c5f6c33b4ea>>
...
export type CreateOrganizationInlineEmbedInput = {
  inlineEmbed: CreateInlineEmbedInputType;
  templateEntityId?: any | null;
};
export type CreateInlineEmbedInputType = {
...
export type CreateInlineEmbedMutation$variables = {
  input: CreateOrganizationInlineEmbedInput;
};
export type CreateInlineEmbedMutation$data = {
  readonly createInlineEmbed: {
...
export type CreateInlineEmbedMutation = {
  response: CreateInlineEmbedMutation$data;
  variables: CreateInlineEmbedMutation$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "CreateInlineEmbedMutation",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
        "concreteType": "CreateOrganizationInlineEmbedPayload",
        "kind": "LinkedField",
        "name": "createInlineEmbed",
        "plural": false,
        "selections": [
          {
            "alias": null,

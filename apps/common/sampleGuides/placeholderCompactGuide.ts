...
const guide = '1693412d-57af-4b8a-b4ae-2cc35fa9b5df' as GuideEntityId;
const modules = ['458b77a3-2c3d-4fb8-b677-3a01a9a671e0' as ModuleEntityId];
const steps = [
  'f12bed9c-b870-4a6f-af8c-d7dc30609bc6' as StepEntityId,
  'd716a3fc-5140-3902-91ba-65a0341848b9' as StepEntityId,
  '248b0021-2b74-4572-b36b-496c3e0bba01' as StepEntityId,
];
const ctaSettings = getDefaultCtaSetting(FORM_FACTOR);

const placeholderCompactGuide: Omit<FullGuide, 'steps'> = {
...
export default placeholderCompactGuide;

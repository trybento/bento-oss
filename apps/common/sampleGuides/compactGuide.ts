...
const THEME = Theme.compact;
const ctaSettings = getDefaultCtaSetting(FORM_FACTOR);

const compactGuide: Omit<FullGuide, 'steps'> = {
  __typename: EmbedTypenames.guide,
  isPreview: true,
  entityId: 'b6538055-644d-4d21-9758-2e131ba76adf' as GuideEntityId,
  ...
  firstIncompleteModule:
    '3ff10961-4117-47ab-af7f-43c766e79d87' as ModuleEntityId,
  firstIncompleteStep: 'e2aa9964-907a-48f1-9434-1afc1ffba9c2' as StepEntityId,
  orderIndex: 0,
  description:
  ...
  modules: [
    {
      entityId: '3ff10961-4117-47ab-af7f-43c766e79d87' as ModuleEntityId,
      guide: 'b6538055-644d-4d21-9758-2e131ba76adf' as GuideEntityId,
      ...
      steps: [
        {
          entityId: 'bd763e54-50bf-4e02-8b7d-401e0101d61e' as StepEntityId,
          mediaReferences: [SAMPLE_IMAGE_MEDIA_REFERENCE_2],
          isComplete: true,
          wasCompletedAutomatically: false,
          manualCompletionDisabled: false,
          state: StepState.complete,
          module: '3ff10961-4117-47ab-af7f-43c766e79d87' as ModuleEntityId,
          guide: 'b6538055-644d-4d21-9758-2e131ba76adf' as GuideEntityId,
          ...
          nextStep: 'e2aa9964-907a-48f1-9434-1afc1ffba9c2' as StepEntityId,
          previousStep: undefined,
        },
        {
          entityId: 'e2aa9964-907a-48f1-9434-1afc1ffba9c2' as StepEntityId,
          mediaReferences: [],
          isComplete: false,
          wasCompletedAutomatically: false,
          manualCompletionDisabled: false,
          ...
          nextStep: '351bb750-34c9-4f43-980b-90007cd4f785' as StepEntityId,
          previousStep: 'bd763e54-50bf-4e02-8b7d-401e0101d61e' as StepEntityId,
        },
        {
          entityId: '351bb750-34c9-4f43-980b-90007cd4f785' as StepEntityId,
          mediaReferences: [],
          isComplete: false,
          wasCompletedAutomatically: false,
          manualCompletionDisabled: false,
          ...
          nextStep: 'dc496b37-534e-4d86-8c0d-f862ae199190' as StepEntityId,
          previousStep: 'e2aa9964-907a-48f1-9434-1afc1ffba9c2' as StepEntityId,
        },
        {
          entityId: 'dc496b37-534e-4d86-8c0d-f862ae199190' as StepEntityId,
          mediaReferences: [],
          isComplete: false,
          wasCompletedAutomatically: false,
          manualCompletionDisabled: false,
          ...
          nextStep: undefined,
          previousStep: '351bb750-34c9-4f43-980b-90007cd4f785' as StepEntityId,
        },
      ],
    },
  ],

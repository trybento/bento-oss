...
const GUIDE_ID = 'd710c51c-8cfa-4832-94c4-60750adef3a8' as GuideEntityId;
const MODULE_IDS = ['079f2a4a-085e-478c-b377-df59da9fc42c' as ModuleEntityId];
const STEP_IDS = [
  '3042255e-da91-4579-983e-403ee9b7b178' as StepEntityId,
  'e363c6d8-510f-4f7c-a1b5-6aa0519c4d84' as StepEntityId,
  '68c83ee5-5244-40e2-b7aa-ca699a93130f' as StepEntityId,
  '4f261d36-0297-465e-bb16-55cb7a8e03b9' as StepEntityId,
];
const ctaSettings = getDefaultCtaSetting(FORM_FACTOR);

const carouselGuide: Omit<FullGuide, 'steps'> = {

...
const guide = '1696412d-57af-4b8a-b4ae-2cc35fa9b5df' as GuideEntityId;
const modules = ['458b77a3-2c3d-4fb8-bf77-3a01a9a671e0' as ModuleEntityId];
const steps = [
  'f12bed9c-b870-4a6f-af8c-d7dc60609bc6' as StepEntityId,
  'd71603fc-5140-3902-91ba-65a0341848b9' as StepEntityId,
  '248b0021-2b04-4572-b36b-496c3e0bba01' as StepEntityId,
];
const ctaSettings = getDefaultCtaSetting(FORM_FACTOR);

const placeholderFlatGuide: Omit<FullGuide, 'steps'> = {
              ...
              children: [
                {
                  ...
                  text: 'Guides using the flat theme will still show the content of completed steps when embedded inline.',
                  type: 'text',
...
export default placeholderFlatGuide;
